    ...
    <div class="row">
      ...
      <div id="sidebar" class="sidebar sidebar-collapsed col-md-2 bg-dark vh-100">
        <ul class="nav flex-column text-white">
          ...
          <li class="nav-item p-3 card-body bg-light bg-opacity-10 border rounded"><i class="bi bi-journal-text"></i><a href="{{route('listaTests.aplicacionTest')}}" class="links_Listas"> Tests</a></li>
