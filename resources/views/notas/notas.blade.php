    ...
    <div class="row">
      ...
      <div id="sidebar" class="sidebar sidebar-collapsed col-md-2 bg-dark vh-100">
        <ul class="nav flex-column text-white">
          ...
          <li class="nav-item p-3 card-body bg-light bg-opacity-10 border rounded"><i class="bi bi-card-text"></i><a href="{{route('notas.notas')}}" class="links_Listas">Notas </a></li>
